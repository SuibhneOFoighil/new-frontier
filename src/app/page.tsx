      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col justify-center">
        <main className="max-w-4xl mx-auto text-center py-6 sm:py-12 lg:py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 md:gap-6 items-center justify-center mb-10 sm:mb-12 lg:mb-16 px-4 sm:px-0">
            ...
            <Link
              className="w-full sm:w-auto font-sans font-semibold px-8 sm:px-8 py-4 sm:py-4 bg-jade-teal hover:bg-jade-teal/90 active:bg-jade-teal/95 text-cream-white rounded-xl transition-all duration-200 hover:shadow-lg active:scale-[0.98] sm:hover:scale-105 focus:outline-none focus:ring-2 focus:ring-jade-teal focus:ring-offset-2 focus:ring-offset-cream-white dark:focus:ring-offset-off-black touch-manipulation min-h-[52px] flex items-center justify-center text-lg"
              href="/subscribe"
            >
              <span>📧 Subscribe</span>
            </Link>
